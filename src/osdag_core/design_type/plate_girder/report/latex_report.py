...
def prepare_report_input(pg_obj, logger):
    ...
    try:
        ...
        if hasattr(pg_obj, 'calculated_deflection'):
             report_input['Maximum deflection observed (mm)'] = getattr(pg_obj, 'calculated_deflection', '-')
        ...
        report_input['Bending moment diagram shape'] = getattr(pg_obj, 'loading_case', 'Uniform Loading')
    ...
    try:
        ...
        if web_philosophy != "Thick Web without ITS":
            ...
            if stiff_width > 0:
                ...
                t_provided_obj = getattr(pg_obj, 'end_panel_stiffener_thickness', 0)
        ...
        t_end_stiff = getattr(pg_obj, 'end_panel_stiffener_thickness', 0)
